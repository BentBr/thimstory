    ...
    <v-app id="app">
        ...
        <v-content>
            <v-container class="fill-height" fluid>
                    ...
                    @auth()
                        <span>Welcome {{ Auth::user()->getName() }}, you are logged in!</span>
                        <v-list>
                            <v-list-item>
                                <v-list-item-title><a href="/{{ Auth()->user()->getUrlName() }}">{{ Auth()->user()->getName() }}</a></v-list-item-title>
                            </v-list-item>
                            <v-list-item>
                                <v-list-item-title><a href="/{{ Auth()->user()->getUrlName() }}/stories">All Stories</a></v-list-item-title>
                            </v-list-item>
                            <v-list-item>
